        ...
        <div className="bg-surface-highlight border border-border rounded-lg p-6 hover:border-primary/50 transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-primary mt-2">{userProjects.length}</p>
            </div>
            ...
            {recentBugs.map((bug) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <span className="text-[10px] font-mono text-text-muted bg-background px-2 py-1 rounded border border-border">
                    #{bug.BugID}
                  </span>
                ...
                <h3 className="font-medium text-text-main text-sm mb-3 line-clamp-2 group-hover:text-primary transition-colors">
                  {bug.Title}
                </h3>
